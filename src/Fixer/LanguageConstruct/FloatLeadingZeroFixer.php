...
{
    /** @use ConfigurableFixerTrait<AutogeneratedInputConfiguration, AutogeneratedComputedConfiguration> */
    ...
    {
        $leadingZero = $this->configuration[self::LEADING_ZERO_CONFIG] ?? self::LEADING_ZERO_ADD;
